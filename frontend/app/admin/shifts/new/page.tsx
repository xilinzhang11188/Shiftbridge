  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (err.message) {
        ...
        setError('Failed to create shift. Please check all fields and try again.');
      }
    } finally {
      setLoading(false);
    }
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  {!formData.client_id ? (
                    ...
                    <p className="text-sm text-gray-500 py-2">
                      No sites available for this client. Please add a site to the client first.
                    </p>
                  ) : (
                    <select
                      id="site_id"
            ...
            <div className="flex justify-end space-x-4 pt-4">
              ...
              <button
                type="submit"
                disabled={loading || clients.length === 0 || services.length === 0}
